        ...
        public static string ShowAlert(Alerts obj, string message)
        {
            ...
            switch (obj)
            {
                case Alerts.Success:
                    ...
                    break;
                case Alerts.Danger:
                    alertDiv = "<div class='alert alert-danger alert-dismissible' id='alert'><button type='button' class='close' data-dismiss='alert'>&times;</button><strong> Success!!</ strong > " + message + "</a>.</div>";
                    break;
                case Alerts.Info:
